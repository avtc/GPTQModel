...
class StageInputsCapture:
    ...
    def cache_inputs(
        ...
        # materilize / move.to CPU for initial input capture
        ...
        # TODO: why data_device sometimes set to CPU (cur_layer_device) and sometimes to CUDA (self.gptq_model.quantize_config.device)?
        try:
